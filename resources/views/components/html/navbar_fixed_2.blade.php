<nav id="fixedNavbar2" class="navbar navbar-expand-lg navbar-light fixed-top bg-light px-xl-5">
    <a class="navbar-brand" href="{{url('/')}}" style="max-width:12rem"><img src="{{asset('img/gng-logo-width-2.png')}}" alt="GnG Dev Logo" class="img-fluid" /></a>
