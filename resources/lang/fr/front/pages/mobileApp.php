...
return [
    ...
    */
    ...
    'section1' => [
        'title' => 'Le Dévéloppement d\'Application Mobile',
        'description' => 'Cum saepe multa, tum memini domi in hemicyclio sedentem, ut solebat, cum et ego essem una et pauci admodum familiares, in eum sermonem illum incidere qui tum forte multis erat in ore.',
        'content' => 'Meministi enim profecto, Attice, et eo magis, quod P. Sulpicio utebare multum, cum is tribunus plebis capitali odio a Q. Pompeio, qui tum erat consul, dissideret, quocum coniunctissime et amantissime vixerat, quanta esset hominum vel admiratio vel querella.',
        'img_alt' => '',
    ],

    'section2' => [
        'title' => 'Demarquez votre Application',
        'description' => 'Constituendi autem sunt qui sint in amicitia fines et quasi termini diligendi. De quibus tres video sententias ferri, quarum nullam probo, unam, ut eodem modo erga amicum adfecti simus, quo erga nosmet ipsos, alteram, ut nostra in amicos benevolentia illorum erga nos benevolentiae pariter aequaliterque respondeat, tertiam, ut, quanti quisque se ipse facit, tanti fiat ab amicis.',
        'content1' => '<h5>DESIGN &amp; HERGONOMIE</h5><p>content_para</p><h5>PERFORMANCE</h5><p>content_para</p>',
        'content2' => '<h5>CONSEILS</h5><p>content_para</p><h5>MAINTENANCE</h5><p>content_para</p>',
    ],
