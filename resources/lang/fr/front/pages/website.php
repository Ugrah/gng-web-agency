...
return [
    ...
    */
    ...
    'section2' => [
        'title' => 'Sites modernes et supports multiples',
        'description' => 'Des sites web optimisés pour téléphone mobile et tablette. Votre site web développé avec les outils les plus avancés.',
    ...
    'section4' => [
        ...
        'content' => '<p>C\'est la question qui revient le plus souvent. Toutefois, c\'est une question complexe à laquelle on ne pourrait pas donner de réponse unique.</p><p>En effet le coût d\'un site internet dépend de la puissance et des fonctionnalités de ce site.</p><p>Afin de vous donner une idée du budget nécessaire à la création de votre site internet vous pouvez consulter la page de tarifs, rédigée pour répondre à la question.</p>',
